...
func (r *RawClient) CreateWithdraw(
	ctx context.Context,
	...
	endpointURL := baseURL + "/api/v4/main-account/withdraw"
...
func (r *RawClient) CreateWithdrawPay(
	ctx context.Context,
	...
	endpointURL := baseURL + "/api/v4/main-account/withdraw-pay"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
