...
func (c *Client) CreateFixedInvestment(
    ...
    opts ...option.RequestOption,
) (*gosdk.CreateFixedInvestmentResponse, error){
...
func (c *Client) GetFixedInvestmentsHistory(
    ...
    opts ...option.RequestOption,
) (*gosdk.GetFixedInvestmentsHistoryResponse, error){
...
func (c *Client) GetInterestPaymentHistory(
    ...
    opts ...option.RequestOption,
) (*gosdk.GetInterestPaymentHistoryResponse, error){
